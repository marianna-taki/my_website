...
After cleaning the data I decided to use bar plots to look at the consumption of the top drinking countries. Below you can see the three graphs for the top 25 beer, wine and spirit drinking countries:


```{r beer_plot, echo=FALSE}
library(ggplot2)
drinks %>%
