...
-	Researched and collected information regarding customer segmentation and targeted advertising,   
focusing on fashion business, to determine main parameters affecting purchasing behavior
...
-	Prepared weekly progress reports and presented findings to company CEO receiving constructive   
...
-	Conducted research on how European countries are developing AI and managed a large database in    
Excel using functions, to assist with a data analytics project with the European Commission
...
-	Completed the PwC Data & Analytics Academy course, learning to utilize data visualization tools   
Tableau and Alteryx and created useful insights for data-driven team project
...
## 2019	ARCH INSURANCE GROUP, Nicosia, Cyprus 
### Actuary Intern (1 month) 
